...
public class ParallelTest1 {
	...
	{
		driver.navigate().to("https://leqlb040.upoint.qc.alight.com/web/bmc/debug");
		System.out.println("Test3 is method is running " +Thread.currentThread().getId() + " Browsername: ");
